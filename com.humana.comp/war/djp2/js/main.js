...
d3.csv('data/summary.csv', function(data) {
  ...
  var xAxis = 'BMI', yAxis = 'Well-being';
  var xAxisOptions = ["Well-being", "Glucose", "Calories Burned", "Calories Consumed", "BMI", "Days since visit", "Days since Vitals"];
  var yAxisOptions = ["Well-being", "Glucose", "Calories Burned", "Calories Consumed", "BMI", "Days since visit", "Days since Vitals"]
  // var yAxisOptions = ["Well-being"];
  var descriptions = {
    "Well-being" : "Customized well-being index",
    "Glucose" : "Blood glucose (mmol/L)",
    "Calories Burned" : "Calories burned (daily avg)",
    "Calories Consumed" : "Calories consumed (daily avg)",
    "BMI": "Body Mass Index",
    "Days since visit" : "Days since last office visit",
    "Days since vitals" : "Days since vitals were last submitted"
  };
